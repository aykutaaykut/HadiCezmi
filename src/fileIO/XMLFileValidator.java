...
public class XMLFileValidator implements FileValidator{
	...
	/**
	 * @param file: File to be checked for XML validation.
	 * @effects If the file fits the schema provided in "cezmi.xsd", it returns "valid" string. Otherwise it returns an error as a string.
	 **/
