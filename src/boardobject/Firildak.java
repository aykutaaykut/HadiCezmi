 ...
 * 
 * @author UC
 * The abstract Firildak class defines one of the subclass of Gizmo superclass and
 * implements Observable interface.
 * Firildak is one of the Gizmo's that have 1Lx1L size and some constant angular velocity rotating around
 * its center.
 */
...
public class Firildak extends Gizmo implements Observable {
	...
	/**
	 * 
	 * @param color: color of the firildak object
	 * @param x: upper left corner x coordinate of the object
	 * @param y: upper left corner y coordinate of the object
	 * @param width: width of the firildak rectangle
	 * @param height: height of the firildak rectangle
	 * @param color: color of the firildak rectangle
	...
	/**
	 * @param observer: any class that implements Observer interface with update() method
