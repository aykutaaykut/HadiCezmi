									...
									if (collisionCheckWithLeftTokat() != null) {
										...
										if(topLineLength != -1 && topLineLength <= getWidth()/2){
											if(hitTokat.isRotatingNow()){
												nextBallVelocity = Geometry.reflectRotatingWall(fakeTopLine,
														center,
														hitTokat.getAngularVelocity()/Constants.frameRate, 
														new Circle(new Vect(getX(), getY()), getWidth()/2), 
														preBallVelocity);
											}else{
												nextBallVelocity = Geometry.reflectWall(fakeTopLine, preBallVelocity, 1);
											}
											...
											if(rightLineLength != -1 && rightLineLength <= getWidth()/2){
												if(hitTokat.isRotatingNow()){
													...
													nextBallVelocity = Geometry.reflectWall(fakeRightLine, preBallVelocity, 1);
												}
												...
												if(bottomLineLength != -1 && bottomLineLength <= getWidth()/2){
													if(hitTokat.isRotatingNow()){
														...
														nextBallVelocity = Geometry.reflectWall(fakeBottomLine, preBallVelocity, 1);
													}
													...
													if(leftLineLength != -1 && leftLineLength <= getWidth()/2){
														if(hitTokat.isRotatingNow()){
															nextBallVelocity = Geometry.reflectRotatingWall(fakeLeftLine,
																	center,
																	hitTokat.getAngularVelocity()/Constants.frameRate, 
																	new Circle(new Vect(getX(), getY()), getWidth()/2), 
																	preBallVelocity);
														}else{
															nextBallVelocity = Geometry.reflectWall(fakeLeftLine, preBallVelocity, 1);
														}
																...
																if(corner3Length <= getWidth()/2){
																	...
																	if(corner4Length <= getWidth()/2){
																		if(hitTokat.isRotatingNow()){
																			...
																			nextBallVelocity = Geometry.reflectCircle(corner4,
																					(new Vect(getX(), getY())), preBallVelocity);
																		}
