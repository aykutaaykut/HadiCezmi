...
public abstract class Tokat extends Gizmo implements Rotatable, Observable {
	...
	private void updateCenters(){
		points[4] = new Vect((points[0].x() + points[1].x()) / 2 , (points[0].y() + points[1].y()) / 2); // head												// center
		points[5] = new Vect((points[2].x() + points[3].x()) / 2 , (points[2].y() + points[3].y()) / 2); // tail												// center
	}
