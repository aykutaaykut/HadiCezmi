 ...
 * 
 * @author UC
 * This class defines the borders of the GameBoard and implements tiny walls.
 */
...
public class Wall extends BoardObject{
	...
	/**
	 * 
	 * @param x: upper left corner x coordinate of the rectangle wall
	 * @param y: upper left corner y coordinate of the rectangle wall
	 * @param width: width of the rectangle wall
	 * @param height: height of the rectangle wall
	 * @requires x and y coordinates, width and height are positive and smaller than 25.
