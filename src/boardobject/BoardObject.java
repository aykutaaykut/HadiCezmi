 ...
 * 
 * @author UC
 * This class is an abstract super class of every board object types.
 *
 */
...
public abstract class BoardObject {
	...
	/**
	 * 
	 * @param x: x-coordinate for the board object.
	 * @requires <code>x</code> must be between 0 and 25.
	 * @modifies x-coordinate of the board object is changed to <code>x</code>.
	 * @effects Sets the x-coordinate of the board object to the given <code>x</code>.
	 */
	...
	/**
	 * 
	 * @param y: y-coordinate for the board object.
	 * @requires <code>y</code> must be between 0 and 25.
	 * @modifies y-coordinate of the board object is changed to <code>y</code>.
	 * @effects Sets the y-coordinate of the board object to the given <code>y</code>.
	 */
	...
	/**
	 * 
	 * @param color: x-coordinate for the board object.
	 * @modifies color of the board object is changed to <code>color</code>.
	 * @effects Sets the color of the board object to the given <code>color</code>.
	 */
	...
	/**
	 * 
	 * @param x: x-coordinate of the board object.
	 * @param y: y-coordinate of the board object.
	 * @param width: width of the board object.
	 * @param height: height of the board object.
	 * @param color: color of the board object.
	 * @requires x-coordinate, y-coordinate, width and height are positive and smaller than 25.
	 ...
	 * @return Returns true if the representation invariant holds for this; otherwise returns false.
	 */
	...
	public String toString(){
		return "[BoardObject= x: " + getX() + ", y: " + getY() + ", width: " + getWidth() + 
				", height: " + getHeight() + " and color: " + getColor().toString() + "]";
	}
