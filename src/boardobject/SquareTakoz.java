 ...
 * 
 *@author UC
 *This class extends Takoz class.
 */
public class SquareTakoz extends Takoz{

	/**
	 * 
	 * @param x: X coordinate of the upper left corner of takoz.
	 * @param y: Y coordinate of the upper left corner of takoz.
	 * @param height: the height of the takoz.
	 * @param width: the width of the takoz.
	 * @param color: The color of the takoz. 
