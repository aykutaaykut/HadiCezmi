 ...
 * 
 * @author UC
 * The concrete Cezerye class defines one of the subclass of Gizmo superclass and
 * implements Observable interfaces.
 * Cezerye object is a speacial object that occurs in the game at random times with random locations.
 * Hitting the cezerye would generate a number of special events.
 */
...
public class Cezerye extends BoardObject implements Observable{
	...
	/**
	 * 
	 * @modifies x, y, width, height and color
	...
	/**
	 * This method removes cezerye from the BoardModel and
	...
	/**
	 * 
	 * @param time: Time for appearance/disappearance of Cezerye.
	 */
