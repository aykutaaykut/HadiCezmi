...
public abstract class Takoz extends Gizmo implements Observable{
	...
	/**
	 * 
	 * @param x: x-coordinate of top left corner of this object.
	 * @param y: y-coordinate of top left corner of this object. 
	...
	/**
	 * Notifies all observers that are observing this object
	 * in order to reflect the object to the screen.
	 */
