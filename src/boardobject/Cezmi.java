...
/**
 * @author UC
 *This class extends BoardObject and implements Observable interface.
 *It has contains all required information about player avatar, Cezmi.
 */
public class Cezmi extends BoardObject implements Observable{
	...
	/**
	 * 
	 * @param x: x-coordinate of the center of Cezmi.
	 * @param y: y-coordinate of the center of Cezmi.
	 * @param color: Color of Cezmi.
	 * @param velocityX: x-velocity of Cezmi.
	 * @param owner: Player who owns the Cezmi.
	...
	public String toString(){
		return "[Cezmi= x: " + getX() + ", y: " + getY() + ", width: " + getWidth() + 
				", height: " + getHeight() + ", color: " + getColor().toString() +
				", velocity: " + getVelocity() + " and owner: " + getOwner().toString() + "]";
	}
	...
	public boolean repOK(){
		if(BoardModel.getInstance().getLevel() == LevelEnum.LEVEL1){
			if(!super.repOK() || owner.equals(null) 
					|| leftLimit.x() > 25 || leftLimit.x() < 0 
					|| rightLimit.x() > 25 || rightLimit.x() < 0) {
				return false;
			}else {
				return true;
			}
			...
			if(!super.repOK() || owner.equals(null) 
					|| leftLimit.x() > 25 || leftLimit.x() < 0 
					|| rightLimit.x() > 25 || rightLimit.x() < 0
					|| leftLimit.y() > 25 || leftLimit.y() < 0 
					|| rightLimit.y() > 25 || rightLimit.y() < 0) {
				return false;
			}else {
				return true;
			}
	...
	/**
	 * 
	 * @param observer: The observer which observes this object.
