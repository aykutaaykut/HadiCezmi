				...
				if (gizmo instanceof SquareTakoz) {
					...
					if (((TriangleTakoz)gizmo).getDirection().equals(DirectionEnum.SOUTH_WEST)) {
						...
						if (polygon.contains(event.getX(), event.getY())) {
							if(BoardModel.getInstance().getCurrentPlayer() == gizmo.getOwner()){
								setTaggedGizmo(gizmo);
								BoardModel.getInstance().getOccupied()[(int) gizmo.getX()][(int) (gizmo.getY()-1)] = false;
								getTimer().start();
								break;
							}
						}
						...
						if (polygon.contains(event.getX(), event.getY())) {
							if(BoardModel.getInstance().getCurrentPlayer() == gizmo.getOwner()){
								setTaggedGizmo(gizmo);
								BoardModel.getInstance().getOccupied()[(int) (gizmo.getX()-1)][(int) (gizmo.getY()-1)] = false;
								getTimer().start();
								break;
							}
						}
						...
						if (polygon.contains(event.getX(), event.getY())) {
							if(BoardModel.getInstance().getCurrentPlayer() == gizmo.getOwner()){
								setTaggedGizmo(gizmo);
								BoardModel.getInstance().getOccupied()[(int) (gizmo.getX()-1)][(int) gizmo.getY()] = false;
								getTimer().start();
								break;
							}
						}
				...
				if(eventX >= 0 && eventX <= 11 && eventY >= 0 && eventY <= 18){
					...
					if(!moved && !isHideGizmo()){
						...
						if (getTaggedGizmo() instanceof SquareTakoz) {
							BoardModel.getInstance().getOccupied()[(int) getTaggedGizmo().getX()][(int) getTaggedGizmo().getY()] = true;
						}else{
							if(getTaggedGizmo() instanceof TriangleTakoz){
								if(((TriangleTakoz) getTaggedGizmo()).getDirection() == DirectionEnum.SOUTH_WEST){
									BoardModel.getInstance().getOccupied()[(int) getTaggedGizmo().getX()][(int) (getTaggedGizmo().getY()-1)] = true;
								}else{
									if(((TriangleTakoz) getTaggedGizmo()).getDirection() == DirectionEnum.SOUTH_EAST){
										BoardModel.getInstance().getOccupied()[(int) (getTaggedGizmo().getX()-1)][(int) (getTaggedGizmo().getY()-1)] = true;
									}else{
										if(((TriangleTakoz) getTaggedGizmo()).getDirection() == DirectionEnum.NORTH_EAST){
											BoardModel.getInstance().getOccupied()[(int) (getTaggedGizmo().getX()-1)][(int) getTaggedGizmo().getY()] = true;
										}else{
											if(((TriangleTakoz) getTaggedGizmo()).getDirection() == DirectionEnum.NORTH_WEST){
												BoardModel.getInstance().getOccupied()[(int) getTaggedGizmo().getX()][(int) getTaggedGizmo().getY()] = true;
											}
										}
									}
								...
								if(getTaggedGizmo() instanceof Firildak){
									for (int i=(int) (getTaggedGizmo().getX()-1); i<=(int) (getTaggedGizmo().getX()+1); i++) {
										for (int j=(int) (getTaggedGizmo().getY()-1); j<=(int) (getTaggedGizmo().getY()+1); j++) {
									...
									if(getTaggedGizmo() instanceof LeftTokat){
										if(((LeftTokat) getTaggedGizmo()).getDirection() == DirectionEnum.SOUTH){
											for (int i=(int) (getTaggedGizmo().getX()); i<=(int) (getTaggedGizmo().getX()+1); i++) {
												for (int j=(int) (getTaggedGizmo().getY()); j<=(int) (getTaggedGizmo().getY()+1); j++) {
													BoardModel.getInstance().getOccupied()[i][j]=true;
												}
											}
										}else{
											if(((LeftTokat) getTaggedGizmo()).getDirection() == DirectionEnum.EAST){
												for (int i=(int) (getTaggedGizmo().getX()); i<=(int) (getTaggedGizmo().getX()+1); i++) {
													for (int j=(int) (getTaggedGizmo().getY()-2); j<=(int) (getTaggedGizmo().getY()-1); j++) {
														BoardModel.getInstance().getOccupied()[i][j]=true;
													}
												}
											}else{
												if(((LeftTokat) getTaggedGizmo()).getDirection() == DirectionEnum.NORTH){
													for (int i=(int) (getTaggedGizmo().getX()-2); i<=(int) (getTaggedGizmo().getX()-1); i++) {
														for (int j=(int) (getTaggedGizmo().getY()-2); j<=(int) (getTaggedGizmo().getY()-1); j++) {
															BoardModel.getInstance().getOccupied()[i][j]=true;
														}
													}
												}else{
													if(((LeftTokat) getTaggedGizmo()).getDirection() == DirectionEnum.WEST){
														for (int i=(int) (getTaggedGizmo().getX()-2); i<=(int) (getTaggedGizmo().getX()-1); i++) {
															for (int j=(int) (getTaggedGizmo().getY()); j<=(int) (getTaggedGizmo().getY()+1); j++) {
																BoardModel.getInstance().getOccupied()[i][j]=true;
															}
										...
										if(getTaggedGizmo() instanceof RightTokat){
											if(((RightTokat) getTaggedGizmo()).getDirection() == DirectionEnum.SOUTH){
												...
												if(((RightTokat) getTaggedGizmo()).getDirection() == DirectionEnum.EAST){
													for (int i=(int) (getTaggedGizmo().getX()); i<=(int) (getTaggedGizmo().getX()+1); i++) {
														for (int j=(int) (getTaggedGizmo().getY()); j<=(int) (getTaggedGizmo().getY()+1); j++) {
															BoardModel.getInstance().getOccupied()[i][j]=true;
														}
													...
													if(((RightTokat) getTaggedGizmo()).getDirection() == DirectionEnum.NORTH){
														for (int i=(int) (getTaggedGizmo().getX()); i<=(int) (getTaggedGizmo().getX()+1); i++) {
															for (int j=(int) (getTaggedGizmo().getY()-2); j<=(int) (getTaggedGizmo().getY()-1); j++) {
																BoardModel.getInstance().getOccupied()[i][j]=true;
															}
														...
														if(((RightTokat) getTaggedGizmo()).getDirection() == DirectionEnum.WEST){
															for (int i=(int) (getTaggedGizmo().getX()-2); i<=(int) (getTaggedGizmo().getX()-1); i++) {
																for (int j=(int) (getTaggedGizmo().getY()-2); j<=(int) (getTaggedGizmo().getY()-1); j++) {
																	BoardModel.getInstance().getOccupied()[i][j]=true;
																}
