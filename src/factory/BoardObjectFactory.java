...
public class BoardObjectFactory{
	...
	public static BoardObjectFactory getInstance() {
		if (instance == null) instance = new BoardObjectFactory();
		return instance;
	}

	/**
	 * 
	 * @param boardObject: Type of the gizmo that is wanted to create.
	 * @param x: x-coordinate of the gizmo that is wanted to create.
	 * @param y: y-coordinate of the gizmo that is wanted to create.
	...
	/**
	 * 
	 * @param boardObject: Type of the board object that is wanted to create.
	 * @param x: x-coordinate of the board object that is wanted to create.
	 * @param y: y-coordinate of the board object that is wanted to create.
	 * @requires x and y coordinates are positive and smaller than 25.
	...
	public BoardObject createBoardObject(BoardObjectEnum boardObject, double x, double y){
		...
		case WALL:
			return new Wall((int) x,(int) y, 0.0, 0.0); // Primitive type mismatch
		default:
			return null;
		}
	}
