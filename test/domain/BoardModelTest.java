...
public class BoardModelTest {
	...
	public void initializeBoardModelLevel1() {
		// This method is for initializing the boardModel for testing. Level is 1.
	...
	public void initializeBoardModelLevel2() {
		// This method is for initializing the boardModel for testing. Level is 2.
		boardModel = BoardModel.getInstance();
	...
	public void testInitializeBallsLevel1() {
		// This method tests "initializeBoardModelLevel1()" method. It checks if the ball created is in the right place or not.
	...
	public void testInitializeBallsLevel2() {
		// This method tests "initializeBoardModelLevel2()" method. It checks if the balls created are in the right places or not.
	...
	public void testInitializePlayers() {
		// This method tests "initializePlayers()" method. It checks if the attributes of both Player objects in "players" list in
	...
	public void testInitializeCezmis() {
		// This method tests "initializeCezmis()" method. It checks if the attributes of both Cezmi objects in "cezmis" list in
		// boardModel object are correct or not. 
		initializeBoardModelLevel1();
		assertEquals("Owner of the first cezmi is wrong.", boardModel.getPlayers().get(0), boardModel.getCezmis().get(0).getOwner());
		assertEquals("Owner of the second cezmi is wrong.", boardModel.getPlayers().get(1), boardModel.getCezmis().get(1).getOwner());
	}
	
	@Test
	public void testInitializeEngel() {
		// This method tests "initializeEngel()" method. It checks if the attributes of Engel object in boardModel object are
		// correct or not.
		initializeBoardModelLevel1();
	...
	public void testInitializeWalls() {
		// This method tests "initializeWalls()" method. It checks if the attributes of both Wall objects in "walls" list in
		// boardModel object are correct or not.
		initializeBoardModelLevel1();
	...
	public void testInitializeState() {
		// This method tests "initializeState()" method. It checks if the state attribute of boardModel object is "StateEnum.PAUSE"
		// or not.
		initializeBoardModelLevel1();
	...
	public void testCurrentPlayer() {
		// This method tests "initializeCurrentPlayer()" method. It checks if the currentPlayer field of boardModel object is first
		// player or not.
		initializeBoardModelLevel1();
		assertEquals("The current player is not the first player.", boardModel.getPlayers().get(0), boardModel.getCurrentPlayer());
	}
	
	@Test
	public void testRandomAvailableCoordinates() {
		// This method tests "randomAvailableCoordinates()" method. It checks if randomly generated coordinate is beetween 0 and 24 or not.
		boardModel = BoardModel.getInstance();
		int[] coordinates = boardModel.randomAvailableCoordinates();
	...
	public void testAddBall() {
		// This method tests addBall() method. It checks if we are able to add a second ball when we are in the first level.
		initializeBoardModelLevel1();
		int[] coordinates = boardModel.randomAvailableCoordinates();
		boardModel.addBall((Ball)BoardObjectFactory.getInstance().createBoardObject(BoardObjectEnum.BALL, coordinates[0], coordinates[1]));
		assertEquals("Second ball cannot be added.", 100, (int)boardModel.getBalls().get(1).getX());
	}
	
	@Test
	public void testMoveGizmo() {
		// This method tests moveGizmo() method. It checks if the initial position of the chosen gizmo becomes empty or not. It also
		// checks if the final position of the chosen gizmo becomes occupied or not.
		initializeBoardModelLevel1();
		...
		assertTrue("Final position is empty in the occupied matrix.", boardModel.getOccupied()[coordinates[0]][coordinates[1]]);
	}
	
	@Test
	public void testDeleteGizmo() {
		// This method tests deleteGizmo() method. It checks if the initial position of the chosen gizmo becomes empty or not.
		initializeBoardModelLevel1();
		boardModel.addGizmo(0,0, BoardObjectEnum.SQUARE_TAKOZ, new Player(0, 0));
	...
	public void testMoveCezmi() {
		// This method tests moveCezmi() method. It checks if the final position of the chosen Cezmi is correct or not.
		initializeBoardModelLevel1();
		...
		assertEquals("Given cezmi's final position is wrong.", oldX-newX,boardModel.getCezmis().get(0).getVelocity(),0);
	}
