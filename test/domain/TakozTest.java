...
public class TakozTest {
	...
	/**
	 * Test whether repOK() returns true or not after creating SquareTakoz object.
	 */
	@Test
	...
	/**
	 * 	 * Test whether repOK() returns true or not after creating TriangleTakoz object.
	 */
	@Test
	...
	/**
	 * Test whether repOK() returns false or not after changing SquareTakoz object's height.
	 */
	@Test
	...
	/**
	 * Test whether repOK() returns false or not after changing TriangleTakoz object's height.
	 */
	@Test
	...
	/**
	 * Test the order of rotation directions of TriangleTakoz.
	 * Starting from SOUTH_WEST, rotation should follow this order:
	 * SW->SE->NE->NW
	 */
	@Test
