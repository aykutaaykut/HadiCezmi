...
public class TokatTest {
	...
	/**
	 * Test whether LeftTokat implements true rotation order during building Mode.
	 * Each rotate command should follow these states:
	...
	/**
	 * Test whether RightTokat implements true rotation order during building Mode.
	 * Each rotate command should follow these states:
	 * NORTH -> EAST -> SOUTH -> WEST
	 */
	@Test
	...
	/**
	 * Test if the rotation is completed after calling rotate method multiple times such that total rotation angle is
	 * 90 degrees. Second 90 degree rotate call should change the boolean of isRunningModeRotatingFinished to false.
	 */
